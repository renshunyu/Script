...
deployhome=/home/aiuap30/auditinernalservice_oracle
buildhome=/home/aiuap/svnproject/program30/builddir/AuditInernalService
...
sudo su - aiuap30 -c "cp $buildhome/target/auditinernalservice-0.0.1-SNAPSHOT-RELEASE.tar.gz $deployhome/"
result=$?
if [ $result != '0' ]
then
