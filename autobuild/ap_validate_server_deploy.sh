...
deployhome=/home/aiuap/zjy/ap_validate_server
...
sudo su aiuap -c "rm -rf $deployhome/ap_validate_server-1.0-SNAPSHOT"
result=$?
if [ $result != '0' ]
then
  echo "删除南研非AUS项目错误"
...
sudo su aiuap -c "cp /home/aiuap/svnproject/program30/builddir/ap_validate_server/target/ap_validate_server-1.0-SNAPSHOT-release.tar.gz /home/aiuap/zjy/ap_validate_server"
result=$?
if [ $result != '0' ]
then
  echo "拷贝南研非AUS项目错误"
