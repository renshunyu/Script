...
deployhome=/home/aiuap30/tomcat_dac
buildhome=/home/aiuap/svnproject/program30/builddir/kettle
sudo su - aiuap30 -c "cd $deployhome/bin && sh shutdown.sh"

while  [ 1 ]
do
result=`ps -ef|grep tomcat_dac|grep -v grep|awk '{print $2}'|sudo pwdx|grep $deployhome/bin |wc -l`
if [ $result = '0' ]
then
