...
svnurl=http://10.1.198.30/svn/UAPPROGRAM/products/ailkiap30/programrm/$1/data-reporting
...
mkdir -p ~/package/sssia/安装包/data-reporting/
result=$?
if [ $result != '0' ]
then
  echo "创建目录错误"
...
cp ./target/*tar.gz ~/package/sssia/安装包/data-reporting/
result=$?
if [ $result != '0' ]
then
  echo "复制安装包错误"
