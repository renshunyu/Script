...
#scp /home/work/source.txt work@192.168.0.10:/home/work/iap_hunandx


deployhome=/home/aiuap30/hndx_iap/tomcat/
buildhome=/home/aiuap/svnproject/program30/builddir/iap_hunandx/target/dist
#cd $deployhome/bin
...
#ssh -p aiuap30# scp -rf $buildhome/iap.war aiuap30@10.21.171.180:/home/aiuap30/hndx_iap/tomcat/webapps
scp -rf $buildhome/iap.war aiuap30@10.21.171.180:/home/aiuap30/hndx_iap/tomcat/webapps
if [ $result != '0' ]
then
  echo "创建审计平台部署目录错误"
  exit 1
