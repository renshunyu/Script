...
deployhome=/home/aiuap30/tomcat_iap
buildhome=/home/aiuap/svnproject/program30/builddir/iap
cd $deployhome/bin
sh shutdown.sh >/dev/null
ps -ef|grep 'tomcat_iap/'|grep -v grep |grep -v tail |awk '{print $2}'|xargs sudo kill -9 
while  [ 1 ]
do
result=`ps -ef|grep /home/aiuap30/tomcat_iap/|grep -v grep|grep -v tail |wc -l`
if [ $result = '0' ]
then
  echo "停止审计平台完毕"
  break;
...
sudo su aiuap30 -c "cp /home/aiuap/svnproject/program30/builddir/iap/target/dist/iap.war /home/aiuap30/tomcat_iap/webapps/iap/iap.war"
result=$?
if [ $result != '0' ]
then
  echo "拷贝审计平台jar包错误"
...
sudo su aiuap30 -c "jar -xvf /home/aiuap30/tomcat_iap/webapps/iap/iap.war"
result=$?
if [ $result != '0' ]
then
  echo "解压审计平台jar包错误"
...
sudo su aiuap30 -c "sh /home/aiuap30/tomcat_iap/iapconfinit/install.sh"
#sudo chgrp -R aiuap iap
#sudo chown -R aiuap30 iap
sudo su aiuap30 -c "sh /home/aiuap30/tomcat_iap/bin/startup.sh"
sudo chmod 777 /home/aiuap30/tomcat_iap/webapps/iap/download
echo $?
