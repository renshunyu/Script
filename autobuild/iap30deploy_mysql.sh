...
deployhome=/home/aiuap30/tomcat_iap_mysql_7.0.62
buildhome=/home/aiuap/svnproject/program30/builddir/iap_mysql
cd $deployhome/bin
sh shutdown.sh >/dev/null
ps -ef|grep 'tomcat_iap_mysql_7.0.62/'|grep -v grep |grep -v tail |awk '{print $2}'|xargs sudo kill -9 
while  [ 1 ]
do
result=`ps -ef|grep /home/aiuap30/tomcat_iap_mysql_7.0.62/|grep -v grep|grep -v tail |wc -l`
if [ $result = '0' ]
then
  echo "停止审计平台完毕"
  break;
...
sudo su aiuap30 -c "cp /home/aiuap/svnproject/program30/builddir/iap_mysql/target/dist/iap.war /home/aiuap30/tomcat_iap_mysql_7.0.62/webapps/iap/iap.war"
result=$?
if [ $result != '0' ]
then
  echo "拷贝审计平台war包错误"
...
sudo su aiuap30 -c "jar -xvf iap.war"
result=$?
if [ $result != '0' ]
then
  echo "解压审计平台jar包错误"
...
sudo su aiuap30 -c "sh /home/aiuap30/tomcat_iap_mysql_7.0.62/iapconfinit/install.sh"
#sudo chgrp -R aiuap iap
#sudo chown -R aiuap30 iap
sudo su aiuap30 -c "sh /home/aiuap30/tomcat_iap_mysql_7.0.62/bin/startup.sh"
sudo chmod 777 /home/aiuap30/tomcat_iap_mysql_7.0.62/webapps/iap/download
echo $?
