...
svnhome=/home/aiuap/svnproject/program30/program/iap_aus
...
mkdir -p $buildhome/iap_aus/dp/conf/ori_log_verification_config
...
cp  $buildhome/iap_aus/ori_log_persistence/src/main/resources/*.* $buildhome/iap_aus/dp/conf/ori_log_persistence_config
cp  $buildhome/iap_aus/data_syn/src/main/resources/*.* $buildhome/iap_aus/dp/conf/data_syn_config
cp  $buildhome/iap_aus/standardize/standardize-component/src/main/resources/*.* $buildhome/iap_aus/dp/conf/standardize_config
...
cp  $buildhome/iap_aus/iap_aus_verification/src/main/resources/*.* $buildhome/iap_aus/dp/conf/ori_log_verification_config
cp  $buildhome/iap_aus/iap_log_persistence_ftp/src/main/resources/*.* $buildhome/iap_aus/dp/conf/log_persistence_ftp_config
...
cp  $buildhome/iap_aus/iap_other_ori_log_persistence/src/main/resources/*.* $buildhome/iap_aus/dp/conf/other_ori_log_persistence_config
