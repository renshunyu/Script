...
sudo su - aiuap30 -c  "mkdir $deployhome/webapps/iap_syn"
if [ $result != '0' ]
then
  echo "创建审计平台部署目录错误"
  exit 1
fi
sudo su - aiuap30 -c  "cp /home/aiuap/svnproject/program30/builddir/iap_syn/target/dist/iap_syn.war /home/aiuap30/tomcat_iap_syn/webapps/iap_syn/iap_syn.war"
result=$?
if [ $result != '0' ]
then
  echo "拷贝审计平台jar包错误"
...
sudo su - aiuap30 -c "cd $deployhome/webapps/iap_syn/ && jar -xvf /home/aiuap30/tomcat_iap_syn/webapps/iap_syn/iap_syn.war"
result=$?
if [ $result != '0' ]
then
  echo "解压审计平台jar包错误"
...
sudo su - aiuap30 -c "sh /home/aiuap30/tomcat_iap_syn/iap_syn_confinit/install.sh && sh /home/aiuap30/tomcat_iap_syn/bin/startup.sh"
echo $?
