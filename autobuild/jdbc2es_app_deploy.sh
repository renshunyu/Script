...
deployhome=/home/aiuap/zjy/jdbc2es-app
...
sudo su aiuap -c "cp /home/aiuap/svnproject/program30/builddir/jdbc2es/target/jdbc2es-0.0.1-SNAPSHOT-release.tar.gz /home/aiuap/zjy/jdbc2es-app"
result=$?
if [ $result != '0' ]
then
