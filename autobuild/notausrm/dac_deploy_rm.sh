...
deployhome=/home/aiuap/aiuap30/aiiapc/tomcat_dacrm
buildhome=/home/aiuap/svnproject/program30rm/fbissue/kettle
sudo su - aiuap30 -c "cd $deployhome/bin && sh shutdown.sh"

while  [ 1 ]
do
result=`ps -ef|grep tomcat_dacrm|grep -v grep|awk '{print $2}'|sudo pwdx|grep $deployhome/bin |wc -l`
if [ $result = '0' ]
then
