...
sed "`awk '$1=="<name>VER</name>"{print (NR+2)}' $jhome/7、将补丁上传至发布平台/config.xml`s/<defaultValue>.*<\/defaultValue>/<defaultValue>$1<\/defaultValue>/g"  $jhome/7、将补丁上传至发布平台/config.xml >7config.xml
